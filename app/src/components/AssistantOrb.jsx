...
export default function AssistantOrb() {
  ...
  return (
    <>
      ...
      >
        {isOpen ? <X color="var(--text-primary)" size={28} /> : <MessageCircle color="var(--text-primary)" size={28} />}
      </motion.div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '0.75rem', paddingRight: '0.5rem' }} className="chat-messages">
              {messages.map(msg => (
